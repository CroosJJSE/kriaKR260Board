...
set_target_properties(g2o::stuff PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_stuff.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_stuff.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::stuff )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::stuff "${_IMPORT_PREFIX}/lib/libg2o_stuff.so.0.1.0" )
...
set_target_properties(g2o::core PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_core.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_core.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::core )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::core "${_IMPORT_PREFIX}/lib/libg2o_core.so.0.1.0" )
...
set_target_properties(g2o::g2o_cli_library PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_cli.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_cli.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::g2o_cli_library )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::g2o_cli_library "${_IMPORT_PREFIX}/lib/libg2o_cli.so.0.1.0" )
...
set_target_properties(g2o::g2o_simulator_library PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_simulator.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_simulator.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::g2o_simulator_library )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::g2o_simulator_library "${_IMPORT_PREFIX}/lib/libg2o_simulator.so.0.1.0" )
...
set_target_properties(g2o::types_slam2d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_slam2d.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_slam2d.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_slam2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_slam2d "${_IMPORT_PREFIX}/lib/libg2o_types_slam2d.so.0.1.0" )
...
set_target_properties(g2o::types_slam2d_addons PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_slam2d_addons.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_slam2d_addons.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_slam2d_addons )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_slam2d_addons "${_IMPORT_PREFIX}/lib/libg2o_types_slam2d_addons.so.0.1.0" )
...
set_target_properties(g2o::types_data PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_data.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_data.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_data )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_data "${_IMPORT_PREFIX}/lib/libg2o_types_data.so.0.1.0" )
...
set_target_properties(g2o::types_sclam2d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_sclam2d.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_sclam2d.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_sclam2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_sclam2d "${_IMPORT_PREFIX}/lib/libg2o_types_sclam2d.so.0.1.0" )
...
set_target_properties(g2o::types_slam3d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_slam3d.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_slam3d.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_slam3d )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_slam3d "${_IMPORT_PREFIX}/lib/libg2o_types_slam3d.so.0.1.0" )
...
set_target_properties(g2o::types_slam3d_addons PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_slam3d_addons.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_slam3d_addons.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_slam3d_addons )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_slam3d_addons "${_IMPORT_PREFIX}/lib/libg2o_types_slam3d_addons.so.0.1.0" )
...
set_target_properties(g2o::types_sba PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_sba.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_sba.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_sba )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_sba "${_IMPORT_PREFIX}/lib/libg2o_types_sba.so.0.1.0" )
...
set_target_properties(g2o::types_icp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_icp.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_icp.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_icp )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_icp "${_IMPORT_PREFIX}/lib/libg2o_types_icp.so.0.1.0" )
...
set_target_properties(g2o::types_sim3 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_types_sim3.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_types_sim3.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::types_sim3 )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::types_sim3 "${_IMPORT_PREFIX}/lib/libg2o_types_sim3.so.0.1.0" )
...
set_target_properties(g2o::solver_pcg PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_solver_pcg.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_solver_pcg.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::solver_pcg )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::solver_pcg "${_IMPORT_PREFIX}/lib/libg2o_solver_pcg.so.0.1.0" )
...
set_target_properties(g2o::solver_dense PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_solver_dense.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_solver_dense.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::solver_dense )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::solver_dense "${_IMPORT_PREFIX}/lib/libg2o_solver_dense.so.0.1.0" )
...
set_target_properties(g2o::solver_slam2d_linear PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_solver_slam2d_linear.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_solver_slam2d_linear.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::solver_slam2d_linear )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::solver_slam2d_linear "${_IMPORT_PREFIX}/lib/libg2o_solver_slam2d_linear.so.0.1.0" )
...
set_target_properties(g2o::solver_structure_only PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_solver_structure_only.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_solver_structure_only.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::solver_structure_only )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::solver_structure_only "${_IMPORT_PREFIX}/lib/libg2o_solver_structure_only.so.0.1.0" )
...
set_target_properties(g2o::solver_eigen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_solver_eigen.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_solver_eigen.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::solver_eigen )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::solver_eigen "${_IMPORT_PREFIX}/lib/libg2o_solver_eigen.so.0.1.0" )
...
set_target_properties(g2o::g2o_hierarchical_library PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libg2o_hierarchical.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libg2o_hierarchical.so.0.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS g2o::g2o_hierarchical_library )
list(APPEND _IMPORT_CHECK_FILES_FOR_g2o::g2o_hierarchical_library "${_IMPORT_PREFIX}/lib/libg2o_hierarchical.so.0.1.0" )
